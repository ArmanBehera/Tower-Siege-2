...
function setup() {
  ...
  brickBreaker = Bodies.circle(103, 266, 40);
...
function draw() {
  ...
  textFont("Algerian");
  text("Press Space Bar to get another chance to play.", 650, 300);
...
function keyPressed(){
  ...
  if (keyCode === 32){
    ...
    Matter.Body.setPosition(brickBreaker, {x : 103, y : 266});
    chain.attach(brickBreaker);
    gameState = "sling";
  }
}